...
import {
	...
	DataCollectionPollMentionableSelectMenuQuestion,
	...
	DataCollectionPollRoleSelectMenuQuestion,
...
export class DataCollectionPoll {
	...
	private _language: LocalizationLanguages;
	...
	private async _sendQuestionContent(question: DataCollectionPollDefaultQuestion<CollectionPollQuestionContentTypes>): Promise<Message<boolean>> {
	...
	private _getQuestionContent(question: DataCollectionPollDefaultQuestion<CollectionPollQuestionContentTypes>): string | EmbedBuilder {
		return(
			question.contentType === CollectionPollQuestionContentTypes.MESSAGE
	...
	private async _getAnswerForStringSelectMenu(question: DataCollectionPollStringSelectMenuQuestion<boolean>): Promise<CollectedStringSelectMenuAnswer| null> {
		const [target, author, options] = this._getPaginationSelectMenuCreateParametersFromQuestion(question);
	...
	private *_getPaginationSelectMenuChoicesFromQuestionAnswers(answers: DataCollectionPollSelectMenuAnswer<boolean>[]): Iterable<SelectMenuOptionWithLocalization> {
...
const modalMenuSendButtons: DataCollectionPollSelectButton<false>[] = [{
	label: TextLocalizationIds.DataCollectionPollModalMenuMessageButton,
